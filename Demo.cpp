...
void demo()
{
	...
	char image1[] ="C:\\images\\CREDIT~1.BMP";
	char image2[] ="C:\\images\\SELECT.BMP";

	char toggleIm, k, s[10];
 	LedDisp(0xc);
    LcdInit();		/* Initialise Lcd screen */
	LcdLine1();LcdMsg("Tap credit card to continue");
	LcdLine2();LcdMsg("");
	...
	while(1) {
		...
		LcdLine1();LcdMsg("Tap credit card to start");
		//LcdLine2();LcdMsg("Press a Key  ...");
	}
	*/
}
